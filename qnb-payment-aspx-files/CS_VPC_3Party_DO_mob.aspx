...
private void Page_Load(object sender, System.EventArgs e)
{
    ...
    */
	...
	string virtualPaymentClientURL = "virtualPaymentClientURL";
	string virtualPaymentClientURL_Val = "https://migs-mtf.mastercard.com.au/vpcpay";
	string Title = "Title";
	string Title_Val = "BSS Online Payment Gateway";
	string vpc_Version = "vpc_Version";
	string vpc_Version_Val = "1";
	string vpc_Command = "vpc_Command";
	string vpc_Command_Val = "pay";
	string vpc_AccessCode = "vpc_AccessCode";
	string vpc_AccessCode_Val = "3477AD3B";
	string vpc_Merchant = "vpc_Merchant";
	string vpc_Merchant_Val = "MECQNB01";
	string vpc_ReturnURL = "vpc_ReturnURL";
	string vpc_ReturnURL_Val_EN = "http://supply-staging.mec.gov.qa/mservice/paymentservice/CS_VPC_3Party_DR_en.aspx";
	string vpc_ReturnURL_Val_AR = "http://supply-staging.mec.gov.qa/mservice/paymentservice/CS_VPC_3Party_DR_ar.aspx";
    ...
    try
    {
        ...
        */
		...
		string queryString = virtualPaymentClientURL_Val;

		transactionData.Add (Title, Title_Val);		
		transactionData.Add (vpc_Version, vpc_Version_Val);
		transactionData.Add (vpc_Command, vpc_Command_Val);
		transactionData.Add (vpc_AccessCode, vpc_AccessCode_Val);
		transactionData.Add (vpc_Merchant, vpc_Merchant_Val);
		
		//transactionData.Add ("vpc_MerchTxnRef", "43857340963");
		//transactionData.Add ("vpc_OrderInfo", "51");
		//transactionData.Add ("vpc_Amount", "5000");
		//transactionData.Add ("vpc_Locale", "en");
		
		//string locale = Page.Request.Form["vpc_Locale"];
		string locale = Page.Request.Form["vpc_Locale"];
		
		if (locale == "ar")
		{
			transactionData.Add (vpc_ReturnURL, vpc_ReturnURL_Val_AR);
		} else {
			transactionData.Add (vpc_ReturnURL, vpc_ReturnURL_Val_EN);
		}
        ...
        */
        ...
        //transactionData.Add ("Title", "Test");  
